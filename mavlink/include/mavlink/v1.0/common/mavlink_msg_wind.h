...
#define MAVLINK_MSG_ID_WIND_MIN_LEN 40
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_wind_send(chan, wind->time_usec, wind->wind_x, wind->wind_y, wind->wind_z, wind->var_horiz, wind->var_vert, wind->wind_alt, wind->pos_horiz_accuracy, wind->pos_vert_accuracy);
#else
